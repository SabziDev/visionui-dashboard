...
const fa = {
  ...
  loadingPage: "درحال بارگذاری صفحه...",
  success: "عملیات با موفقیت انجام شد",
  errors: {
    network: "خطا در ارتباط با سرور! اتصال اینترنت را بررسی و دوباره تلاش کنید",
    timeout: "درخواست بیش از حد طول کشید",
    server: "یه مشکلی در سرور پیش آمد! لطفا دوباره تلاش کنید",

    access: "شما اجازه دسترسی به این منبع را ندارید",
    notFound: "اطلاعات درخواستی پیدا نشد! لطفا دوباره تلاش کنید",
    conflict:
      "این درخواست با وضعیت فعلی اطلاعات سازگار نیست! اطلاعات را بررسی و دوباره تلاش کنید",
